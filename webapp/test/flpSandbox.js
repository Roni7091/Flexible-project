		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comexampleflexibleproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexampleflexibleproject-display": {
								"semanticObject": "comexampleflexibleproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.flexibleproject",
									"url": sap.ui.require.toUrl("com/example/flexibleproject")
								}
							}
						}
					}
